...
- [[#other-self-managed-plugins][Other self-managed plugins]]
...
#+end_src
* Other self-managed plugins
Also install and source [[https://github.com/MichaelAquilina/zsh-auto-notify][zsh-auto-notify]] and [[https://github.com/MichaelAquilina/zsh-you-should-use][zsh-you-should-use]].
TODO: Perhaps use zplug to manage all these plugins.
#+begin_src sh
